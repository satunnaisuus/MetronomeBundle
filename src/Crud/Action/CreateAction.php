...
class CreateAction extends AbstractAction
{
    public function handle(AdminContext $context): Response
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->render('@Metronome/crud/form.html.twig', array_merge($this->getViewParameters($context), [
        ...
        return $this->render('@Metronome/crud/action_create.html.twig', array_merge($this->getViewParameters($context), [
            'form' => $form->createView(),
        ]));
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefault('template', '@Metronome/crud/button/create.html.twig');
